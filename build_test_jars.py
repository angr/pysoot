...
if __name__ == "__main__":
    code_path = os.path.join(self_dir, "tests", "test_samples", "simple1_code")
    out_path = os.path.join(self_dir, "tests", "test_samples", "simple1.jar")
    try:
        os.unlink(out_path)
    except OSError:
        pass
    ...
    code_path = os.path.join(self_dir, "tests", "test_samples", "simple2_code")
    out_path = os.path.join(self_dir, "tests", "test_samples", "simple2.jar")
    try:
        os.unlink(out_path)
    except OSError:
        pass
